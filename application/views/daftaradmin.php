...
<section id="feature" class="parallax-section col-md-12">
  <div class="col-md-12">
    ...
    <?php if($this->session->userdata('role') == 1)
              {?>
    <a class="btn btn-primary" href="<?php echo base_url(). 'home/tambahadmin'; ?>">Tambah Admin</a>
    <?php } else {?>
    <?php } ?>
    <div class="row">
      <!-- <div class="col-md-12">
    ...
    <?php $id=1; foreach($user as $admin){
    ?>
    <tbody>
    <tr>
      <?php if($this->session->userdata('role') == 1)
      ...
      <td>
        <a class="btn btn-warning" href="<?php echo base_url('sewagedung/editadmin/'.$admin->id_user); ?>">Edit</a>
        <a class="btn btn-danger" href="<?php echo base_url('sewagedung/hapusadmin/'.$admin->id_user); ?>">Delete</a>
      </td>
        <?php } else {?>
      <td><?php echo $id++ ?></td>
     <td><?php echo $admin->namalengkap ?></td>
