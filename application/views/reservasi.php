                ...
                <div class="row" >
                    ...
                    <div class="col-12 col-md-7 item" >
                        <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s" >
                            <h2 class="contact-form-title mb-30">Silahkan Isi</h2>
                            <!-- Contact Form -->
                            <form action="<?php echo base_url(). 'sewagedung/tambahdata'; ?>" method="post">
                                ...
                                <div class="form-group">
                                    <input name="telp" type="text" class="form-control" id="contact-website" placeholder="Telp">
                                </div>
                                <div class="form-group">
                                    <input name="jenisgedung" type="text" class="form-control" id="contact-website" placeholder="Jenis Gedung">
                                </div>
                                <div class="form-group">
                                    <input name="waktusewa" type="text" class="form-control" autocomplete="off" id="datepicker" placeholder="Waktu Penyewaan (Misal : 2020-11-22)">
                                </div>
                                <div class="form-group">
                                    <input name="lamasewa" type="text" class="form-control" id="contact-website" placeholder="Lama Sewa">
                                </div>
                                <div class="form-group">
                                    <textarea name="message" class="form-control" name="message" id="message" cols="30" rows="10" placeholder="Message"></textarea>
                                </div>
                                <button type="submit" class="nav-link form-control submit" onclick="myFunction()">Reservasi</a></button>
                                <script>
                                function myFunction() {
