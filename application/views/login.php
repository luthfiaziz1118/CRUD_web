                ...
                -->
                    ...
                    <div class="col-12 col-md-7 item">
                        <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s" style=" margin: 50px">
                            ...
                            <!-- Contact Form -->
                          <form action="<?php echo base_url('sewagedung/aksi_login_user'); ?>" method="post">
                                <div class="form-group">
                                    <input name="username" type="text" class="form-control" id="contact-name" placeholder ="Username">
                                </div>
                                <div class="form-group">
                                    <input name="password" type="password" class="form-control" id="contact-email" placeholder ="Password">
                                </div>
                                
                   
                                <button type="submit" class="nav-link">Sign in</button>

                                <p>Belum punya akun ?<a href="<?php echo base_url().'home/signup';?>" class="read-more"> Klik disini</a></p>
