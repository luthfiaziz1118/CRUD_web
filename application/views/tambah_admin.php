                ...
                -->
                    ...
                    <div class="col-12 col-md-7 item">
                        <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s" style=" margin: 50px">
                            ...
                            <!-- Contact Form -->
                          <form action="<?php echo base_url(). 'sewagedung/tambahadmin'; ?>" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-name" placeholder ="Nama Lengkap" name="namalengkap">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-name" placeholder ="Email" name="email">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-name" placeholder ="Telp" name="telp">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-name" placeholder ="Alamat" name="alamat">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-name" placeholder ="Username" name="username">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" id="contact-email" placeholder ="Password" name="password">
                                </div>
                                <!-- <div class="form-group">
                                    <input type="password" class="form-control" id="contact-email" placeholder ="Konfirmasi Password" name="konfirmpassword">
                                </div> -->
                                
                                <button type="submit" class="nav-link" onclick="myFunction()">Daftar Akun</button>
                                <script>
                                function myFunction() {
                                alert("Terimakasih sudah daftar akun! Kami akan mengirimkan verifikasi melalui email Anda.");
                                }
                                </script>        
